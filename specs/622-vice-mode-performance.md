...
**Parent specs:** `specs/_archive/600-runtime-proof-gates.md` (literal-port renderer is the proof oracle — must NOT be weakened), `specs/611-new-vice1541-side-by-side.md`, `specs/_archive/618-fastloader-dd00.md`.
