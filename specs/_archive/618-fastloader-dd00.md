...
**Parent specs:** `specs/_archive/611-new-vice1541-side-by-side.md`, `specs/_archive/612-1541-port-fidelity-rules.md`, `specs/_archive/620-port-bug-forensic-doctrine.md`, `specs/_archive/615-gcr-decode-fidelity.md`, `specs/_archive/616-kernal-load-fidelity.md`, `specs/_archive/617-kernal-save-fidelity.md`
...
- `specs/_archive/612-1541-port-fidelity-rules.md`
- `specs/_archive/620-port-bug-forensic-doctrine.md`
- `specs/_archive/615-gcr-decode-fidelity.md`
