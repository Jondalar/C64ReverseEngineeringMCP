...
**Replaces row 612 in:** `specs/_archive/610-1541-parity-rebuild-charter.md` ("(superseded by Spec 611 phases)" — that row is reclaimed by this spec).
...
- `specs/_archive/610-1541-parity-rebuild-charter.md` — charter.
- `specs/_archive/611-new-vice1541-side-by-side.md` — side-by-side build.
