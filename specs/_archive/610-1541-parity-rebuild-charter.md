...
|------|------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------|
| 611  | VICE-derived 1541, side-by-side full-port batch | As defined in `specs/_archive/611-new-vice1541-side-by-side.md`. Builds new `drive1541-vice` next to legacy; legacy frozen; factory + Drive1541 interface; missing VICE1541 source modules are ported as one integrated batch before KERNAL LOAD is judged. | Full-port / integration gates in `specs/611-...md` §5 + §6. Master default stays `legacy` and 5/7 GREEN until the VICE1541 default flip. |
