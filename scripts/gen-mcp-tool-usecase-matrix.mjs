...
const CURATED = {
  ...
  // Spec 829 — a BASIC PRG is not 6502; disasm_prg renders its token bytes as garbage.
  basic_list: { role: "static-analysis", swimlane: "disassembly-improve", useWhen: "Read a BASIC V2 PRG: walk its line records, detokenise, name the PETSCII control codes, and report the SYS targets that hand control to machine code.", notFor: "A machine-code payload — use analyze_prg then disasm_prg.", adjacent: ["disasm_prg", "analyze_prg", "basic_tokenize"], e2e: ["E2E-C"] },
