...
// Runs all 7 game scenarios in sequence. Each must reach in-game
...
const GAMES = [
  ...
  { name: "lnr",       script: "scripts/test-lnr-screenshots.mjs",       hint: "Last Ninja Remix System 3 title / PRESS FIRE" },
  ...
  { name: "polarbear", script: "scripts/test-polarbear-screenshots.mjs", hint: "Photosensitive warning / TOP SCORES menu" },
];
