...
export const GATES = [
  ...
  // Small, fast, real. Each cut to earliest stable PASS.
  {
    ...
    triggers: ["src/ts-emulator/vice1541/**", "src/ts-emulator/iec*/**"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/cartridge.ts", "src/ts-emulator/memory-bus.ts"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/inspect/**", "src/ts-emulator/integrated-session.ts"],
  ...
  // Big subsystem suites. NOT the product baseline. Run on subsystem change.
  {
    ...
    triggers: ["src/ts-emulator/vice1541/**", "src/runtime/**/vic*/**", "src/runtime/**/cpu*/**"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/vice1541/**", "src/disk/**"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/cartridge.ts", "src/ts-emulator/m93c86.ts", "src/ts-emulator/spi-flash.ts"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/cartridge.ts"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/cartridge.ts", "src/runtime/**/media*/**"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/cartridge.ts", "src/runtime/**/checkpoint*/**"],
  ...
  },
  {
    ...
    expect: "exit0", tier: 2, fixtures: "synthetic GMOD2/3/MegaByter/C64MegaCart",
    triggers: ["src/ts-emulator/cartridge.ts", "src/runtime/**/checkpoint*/**", "src/runtime/**/ring*/**"],
  ...
  },
  {
    ...
    triggers: ["src/ts-emulator/vice1541/drive_snapshot.ts", "src/runtime/**/checkpoint*/**", "src/runtime/**/ring*/**"],
