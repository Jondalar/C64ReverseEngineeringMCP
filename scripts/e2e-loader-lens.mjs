...
// Run after build:mcp.
import { buildLandingMap, buildReadSet, halftrackToTrack } from "../src/trace/loader-lens.js";
import { TraceOp, ACCESS_WRITE, ACCESS_READ } from "../src/trace/binary-format.js";
