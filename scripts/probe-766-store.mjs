...
import { AnchorStore } from "../dist/ts-emulator/recorder/anchor-store.js";
import {
  encodeAnchorRecord, encodeMediumRecord, REC_ANCHOR, REC_MEDIUM,
  MEDIUM_KIND_DISK, MEDIUM_KIND_CART,
} from "../dist/ts-emulator/recorder/anchor-record.js";
import {
  RecorderRingProducer, createRecorderRingSab,
} from "../dist/ts-emulator/recorder/recorder-ring.js";
...
const workerPath = resolve(here, "../dist/ts-emulator/recorder/recorder-worker.js");
