...
| BUG-032 | No steering/persona makes the agent record findings + reconcile open questions after each action → answered questions stay `open`, findings never linked to questions, Questions tab buried under ~127 heuristic "Validate RAM region" auto-noise. | mcp-tool / agent-steering | medium | open |
