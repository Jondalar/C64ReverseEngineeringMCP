...
| BUG-025 | Inspector/Frozen overlay poisons Pause/Run resume with alarm-dispatch guard | runtime / live-ui / inspector | high | investigating (root cause PROVEN: no clkguard → maincpu_clk wraps 2^32, alarms un-warped → drainAlarms spins; Inspector = warp-paced accelerant, not cause. Fix specced 743, impl pending) |
| BUG-026 | Host ESC is mapped to RUN/STOP instead of C64 ESC | runtime / live-ui / keyboard | medium | open |
