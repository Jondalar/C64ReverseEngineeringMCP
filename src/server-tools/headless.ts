    ...
    safeHandler("runtime_session_start", async ({
      ...
      if (r.attached && absMedia) {
        refusedLine =
          ...
          `To run YOUR medium on a machine of your own: runtime_scene_reel — a private daemon on its own port that ends on a budget.`;
      }
