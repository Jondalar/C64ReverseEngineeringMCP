    ...
    safeHandler("runtime_session_start", async ({
      ...
      if (r.attached && absMedia) {
        refusedLine =
          ...
          `To run YOUR medium on a machine of your own: runtime_sandbox_run, or runtime_scene_reel for a scripted run.`;
      }
