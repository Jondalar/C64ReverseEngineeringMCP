...
//   - src/ts-emulator/_quarantine_vice1541_v4/via6522.ts (1939 LOC,
//     lazy-T1 fallback — PL-5 violation, dropped)
//   - src/ts-emulator/via/via6522-vice.ts (1341 LOC, class-based,
...
// one home).
//
// Alarm scheduling uses src/ts-emulator/alarm/alarm-context.ts which is
...
// src/ts-emulator/vice1541/snapshot.ts (Spec 705.A step 1). Because
