...
| 104 | C64 hardware — VIC + bus ✓ DONE 2026-05-04 | 105 ✓, 106 ✓ (M2.3-4)               | medium   | M2.3 VIC-II per-char-row dispatch (10/10) — fixes MM character-selection rendering. M2.4 PLA + memory bus v1 (22/22, color RAM nibble) — Ultimax + cart hooks deferred to M6. |
