...
VIC fidelity is INCOMPLETE while frame border/background ratios
diverge from VICE. Visual oracle + binding requirements:
[`refs/vic-render-proportions.md`](./refs/vic-render-proportions.md).
The reference PNG is the boot READY screen; same proportions apply
to every frame the renderer emits.
